                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    {collections.map((col, idx) => (
                        <motion.div
                            ...
                            className="group relative aspect-[16/10] bg-[#0A0A0A] border border-white/[0.03] hover:border-gold/30 rounded-2xl transition-all duration-700 overflow-hidden cursor-pointer shadow-2xl"
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-black/20 group-hover:from-black/80 group-hover:via-black/20 group-hover:to-transparent transition-all duration-700" />

                            {/* Center Diamond watermark (fades out on hover to let image shine) */}
                            <Diamond className="absolute right-6 top-6 w-16 h-16 text-white/[0.05] group-hover:opacity-0 transition-opacity duration-700" strokeWidth={0.3} />

                            {/* Text Content */}
                            <div className="absolute bottom-0 left-0 p-8 z-10 w-full translate-y-4 group-hover:translate-y-0 transition-transform duration-700">
                                <p className="text-[9px] tracking-[0.25em] uppercase text-gold/70 mb-2 font-medium drop-shadow-md">Collection</p>
                                <h3 className="text-2xl font-serif text-white group-hover:text-gold transition-colors duration-500 mb-2 drop-shadow-lg">
                                    {col.name}
                                </h3>
                                <p className="text-sm text-white/50 font-light opacity-0 group-hover:opacity-100 transition-all duration-700 delay-100">
                                    {col.desc}
                                </p>
                            </div>
